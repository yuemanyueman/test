...
<head>
	...
	<link rel="stylesheet" href="/lengyun/Public/Admin/css/login.css" />
			...
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img id='img' src="<?php echo U('verify');?>" /></cite>
                    </p>
                </div>
...
$('#img').click(function(){
    // 重新设置img标签的src属性，使用随机数来防止缓存问题。
    $(this).attr({"src" : "/lengyun/Admin/Login/verify/_/"+Math.random()})
})

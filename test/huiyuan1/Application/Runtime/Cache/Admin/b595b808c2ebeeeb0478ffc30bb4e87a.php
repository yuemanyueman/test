...
<link rel="stylesheet" type="text/css" href="/lengyun/Public/Admin/css/jquery.dialog.css" />
<link rel="stylesheet" href="/lengyun/Public/Admin/css/index.css" />
  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        <div class="welcome ue-clear"><span>欢迎您,</span><span class="ts" href="javascript:;" ><?php echo (session('name')); ?></span></div>
    ...
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            <div class="nav-header"><a href="javascript:;" class="ue-clear" date-src="<?php echo U('Product/index');?>"><span>产品管理</span><i class="icon"></i></a></div>
          </li>
          <li class="nav-info">
            <div class="nav-header"><a href="javascript:;" class="ue-clear" date-src="<?php echo U('Product2/index');?>"><span>展示中心</span><i class="icon"></i></a></div>
            <!-- <ul class="subnav">
          ...
          <li class="agency">
            <div class="nav-header"><a href="javascript:;" class="ue-clear" date-src="<?php echo U('News/index');?>"><span>资讯管理</span><i class="icon"></i></a></div>
          </li>
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear" date-src="<?php echo U('Message/index');?>"><span>留言管理</span><i class="icon"></i></a></div>
          </li>
...
<script type="text/javascript" src="/lengyun/Public/Admin/js/jquery.dialog.js"></script>
<script type="text/javascript" src="/lengyun/Public/Admin/js/index.js"></script>
</html>